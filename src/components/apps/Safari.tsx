          ...
          <div className="flex-1 mx-2">
            <div className="flex items-center bg-neutral-200/60 dark:bg-[#3A3A3C] rounded-md px-2 border border-transparent">
              ...
              <input
                ...
                className="w-full bg-transparent py-1.5 text-start mx-4 px-1.5 text-sm text-black dark:text-white placeholder:text-black/60 dark:placeholder:text-white/60 ring-1 ring-white/30 focus:ring-2 focus:ring-blue-500 rounded-md focus:outline-none"
