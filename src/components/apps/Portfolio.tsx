...
const Portfolio = () => {
    ...
    const allImages = selectedProject ? [selectedProject.mainImage, ...selectedProject.gallery].filter(img => img && typeof img === 'object' && 'imageUrl' in img && !!img.imageUrl) as { imageUrl: string; imageHint: string }[] : [];
