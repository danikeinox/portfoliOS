...
const Services = () => {
    ...
    const handleServiceClick = (service: Service) => {
        ...
        const prefilledMessage = t('services.requestInfoTemplate', { service: serviceTitle });
        router.push(`/app/messages?service=${encodeURIComponent(serviceTitle)}&message=${encodeURIComponent(prefilledMessage)}`);
    };
                ...
                <div className="bg-white dark:bg-[#1C1C1E] rounded-xl overflow-hidden mx-4 my-4">
                    {services.map((service) => (
                        <button
                            ...
                            className="w-full text-left border-b border-neutral-200 dark:border-[#38383A] last:border-none ml-4"
                        >
