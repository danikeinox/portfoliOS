  ...
  return (
    <div className="w-full h-full bg-white dark:bg-black text-black dark:text-white flex flex-col">
      <div className="flex-1 overflow-y-auto pb-24">
       ...
       <div className="absolute bottom-0 left-0 right-0 h-20 bg-neutral-100/80 dark:bg-neutral-900/80 backdrop-blur-md border-t border-neutral-200 dark:border-neutral-800 flex justify-around items-center pt-1 pb-[env(safe-area-inset-bottom)]">
